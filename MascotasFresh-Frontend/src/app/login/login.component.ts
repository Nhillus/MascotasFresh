...
export class LoginComponent implements OnInit {
  ...
  submit() {
    ...
    let data = {                            //Creo La data que sera enviada al servidor, con su usuario y contraseña,ademas como usamos OAuth 2.0 dejamos en la data la forma
      ...
      client_secret:'HXcvgIXW8AgAFqRa3FlnHoZKqT3YBQnCfyloiS0F',       //Tal vez usando claves privadas con publicas (Nota para mi: recuerda seguridad wilmer claves privadas publicas)
    };
